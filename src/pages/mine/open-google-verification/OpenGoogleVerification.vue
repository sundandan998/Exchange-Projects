<template>
  <el-form :label-position="labelPosition" :model="verification" ref="verification" :rules="rules" label-width="100px" class="exchange-mine-open-google">
    <div class="exchange-mine-open-google-from">
      ...
      <el-steps :active="active" finish-status="success" class="exchange-mine-open-google-step">
        <el-step title="1、下载APP"></el-step>
        <el-step title="2、扫描二维码"></el-step>
        <el-step title="3、备份密钥"></el-step>
        <el-step title="4、开启谷歌验证"></el-step>
      </el-steps>
      <!-- <div class="exchange-mine-open-google-step-one">
        <p>下载并安装谷歌验证器APP</p>
        <ul>
